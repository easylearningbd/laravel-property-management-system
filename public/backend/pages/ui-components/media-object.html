...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div class="d-flex align-items-start">
	...
	<div>
		...
		<p>Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.</p>
						...
						<div class="example">
							<div class="d-flex align-items-start">
								<img src="../../../assets/images/others/placeholder.jpg" class="wd-100 wd-sm-150 me-3" alt="...">
								<div>
									<h5 class="mb-2">Media heading</h5>
									...
									<div class="d-flex align-items-start mt-3">
										<a class="me-3" href="#">
											<img src="../../../assets/images/others/placeholder.jpg" class="wd-100 wd-sm-150" alt="...">
										</a>
										<div>
											<h5 class="mb-2">Media heading</h5>
											Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.
		...
		<div class="d-flex align-items-start mt-3">
			...
			<div>
				...
				Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.
						...
						<div class="example">
							<div class="d-flex align-items-start">
								<img src="../../../assets/images/others/placeholder.jpg" class="align-self-start wd-100 wd-sm-150 me-3" alt="...">
								<div>
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div class="d-flex align-items-start">
	...
	<div>
		...
		<p>Donec sed odio dui. Nullam quis risus eget urna mollis ornare vel eu leo. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.</p>
						...
						<div class="example">
							<div class="d-flex align-items-start">
								<img src="../../../assets/images/others/placeholder.jpg" class="align-self-center wd-100 wd-sm-150 me-3" alt="...">
								<div>
...
<pre><code class="language-markup"><script type="script/prism-html-markup"><div class="d-flex align-items-start">
	...
	<div>
		...
						...
						<div class="example">
							<div class="d-flex align-items-start">
								<img src="../../../assets/images/others/placeholder.jpg" class="align-self-end wd-100 wd-sm-150 me-3" alt="...">
								<div>
		...
		...
						...
						<div class="example">
							<div class="d-flex align-items-start">
								...
								<img src="../../../assets/images/others/placeholder.jpg" class="wd-100 wd-sm-150 ms-3" alt="...">
							</div>
						</div>
